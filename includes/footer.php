...
<li><a href="https://urbanstalls.com/admin/"><i class="icon fa fa-sign-in"></i>&nbsp R&D Team Login</a></li> 
...
<li><a href="https://urbanstalls.com/sellerdetail.php"><i class="icon fa fa-sign-in"></i>&nbsp Feedback Seller</a></li>              </a>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Brought To You By <a href="localhost/shopping/">Amalina WebTech </a></p>
...
<div class="contact-timing">
	...
	<div class="module-body outer-top-xs">
		<div class="table-responsive">
			<table class="table">
				<tbody>
					<tr><td>Monday-Sunday:</td><td class="pull-right">10:00AM To 06:00PM</td></tr>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+234) 09066754911<br>(+234) 09038091292</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="https://meimunamart.com/">Mrs Haidar.com</a></span>
                </div>
            </li>
