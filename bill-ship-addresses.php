...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update useN set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update useN set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<html lang="en">
	<head>
		<!-- Meta -->
		<meta chaNet="utf-8">
		<meta http-equiv="Content-Type" content="text/html; chaNet=UTF-8">
...
<?php
$query=mysqli_query($con,"select * from useN where id='".$_SESSION['id']."'");
